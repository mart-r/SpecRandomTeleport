...
public abstract class PerWorldLocationTestsBase extends MessageTestsBase {
    private PerWorldNamedLocationProvider provider;

    public abstract PerWorldNamedLocationProvider getProvider();
