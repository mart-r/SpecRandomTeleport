...
public class MockServer implements Server {
    ...
    private final String serverName = "MockServer!";
    ...
    @Override
    public <T extends Keyed> Tag<T> getTag(String registry, NamespacedKey tag,
            Class<T> clazz) {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    @Override
    public KeyedBossBar createBossBar(NamespacedKey key, String title,
